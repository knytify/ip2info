...
db_ip2proxy.open(b"C:\\Users\\bette\\ipdata\\IP2PROXY-LITE-PX4.BIN")
...
record_ip2proxy = db_ip2proxy.get_all(b"1.0.4.1")
record_ip2location = db_ip2location.get_all(b"94.252.122.6").__dict__
